...
namespace smoga
{
    ...
    public:
        ...
        /**
         * @brief setFitness Set the vector of fitness. Lenght of this vector will be the number of objectives.
         * @param fitness Fitness Vector.
         */
        inline void setFitness(const std::vector < F >& fitness) { m_fitness = fitness; }
    ...
    std::string Chromosome<F, DATA>::datasToStr()
    {
        ...
        const unsigned int nbGenes = m_datas.size();
